...
Serializers _$serializers = (new Serializers().toBuilder()
      ..add(AddCartResponse.serializer)
      ..add(CartItemEntity.serializer)
      ..add(CartItemPIdResponse.serializer)
      ..add(CartItemResponse.serializer)
      ...
      ..addBuilderFactory(
          ...
          () => new ListBuilder<CartItemPIdResponse>()))
    .build();
